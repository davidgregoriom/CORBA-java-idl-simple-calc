            ...
            while (true) {
                ...
                try {
                    ...
                    if (opt.equals("8")) {
                        ...
                        out.println("a^b= " + calcImpl.pot(getFloat("a"), getFloat("b")));
                    }else if (opt.equals("6")) {
                        out.println("av-b= " + calcImpl.rai(getFloat("a"), getFloat("b")));
                    }else if (opt.equals("7")) {
                        out.println("logbA= " + calcImpl.log(getFloat("a"), getFloat("b")));
                    }
                } catch (Exception e) {
                    out.println("===");
